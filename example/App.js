...
import ReactNativeSarawakpay, {OpenSPay} from 'react-native-sarawakpay';
...
export default class App extends Component<{}> {
  ...
  // const onPress = () => {
  //   // SpayModule.createCalendarEvent('Nichoals', 'And go to location');
  //   SpayModule.sendRequest(orderEncryptedString)
  // };
  onPress = () => {
